...
namespace taske_tracking.Controllers
{
    ...
    public class JobsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,JobTitel,JobContent,JobImage,CategoryId")] Job job,HttpPostedFileBase Upload)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,JobTitel,JobContent,JobImage,CategoryId")] Job job)
        {
            if (ModelState.IsValid)
            {
